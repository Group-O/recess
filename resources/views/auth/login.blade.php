@extends('layouts/app', ['activePage' => 'login', 'title' => 'ANKA Business Support Services'])

@section('content')
    <div class="full-page section-image" data-image="{{ asset('light-bootstrap/img/2593044.jpg') }}">
                            ...
                            <div class="card-body ">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-14">
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', 'andrew@gmail.com') }}" required autocomplete="email" autofocus>
