@extends('layouts.app', ['activePage' => 'dashboard', 'title' => 'ANKA Business Support Services', 'navName' => 'Dashboard', 'activeButton' => 'laravel'])
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ __('Create Invisible User Experiences you Never Knew About') }}</td>
                                            <td class="td-actions text-right">
                                                <button type="button" rel="tooltip" title="Edit Task" class="btn btn-info btn-simple btn-link">
                                                    <i class="fa fa-edit"></i>
                                                </button>
